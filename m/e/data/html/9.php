...
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=titlepic<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>游戏分类</td><td bgcolor='ffffff'><input name="gametype" type="radio" value="1"<?=$r[gametype]=="1"||$ecmsfirstpost==1?' checked':''?>>角色扮演<input name="gametype" type="radio" value="2"<?=$r[gametype]=="2"?' checked':''?>>休闲益智<input name="gametype" type="radio" value="3"<?=$r[gametype]=="3"?' checked':''?>>竞技对战<input name="gametype" type="radio" value="4"<?=$r[gametype]=="4"?' checked':''?>>音乐舞蹈<input name="gametype" type="radio" value="5"<?=$r[gametype]=="5"?' checked':''?>>塔防策略<input name="gametype" type="radio" value="6"<?=$r[gametype]=="6"?' checked':''?>>模拟经营<input name="gametype" type="radio" value="7"<?=$r[gametype]=="7"?' checked':''?>>冒险解谜<input name="gametype" type="radio" value="8"<?=$r[gametype]=="8"?' checked':''?>>卡牌战略<input name="gametype" type="radio" value="9"<?=$r[gametype]=="9"?' checked':''?>>其他游戏<input name="gametype" type="radio" value="10"<?=$r[gametype]=="10"?' checked':''?>>h5游戏</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>语言</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>安卓下载</td><td bgcolor='ffffff'>
<input name="anurl" type="text" id="anurl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[anurl]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=0&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=anurl<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的文件"><img src="../data/images/changefile.gif" border="0" align="absbottom"></a>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>苹果下载</td><td bgcolor='ffffff'>
<input name="iosurl" type="text" id="iosurl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[iosurl]))?>" size="45">
<a onclick="window.open('ecmseditor/FileMain.php?type=0&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=iosurl<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的文件"><img src="../data/images/changefile.gif" border="0" align="absbottom"></a>
