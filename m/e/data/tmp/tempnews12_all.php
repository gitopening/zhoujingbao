  ...
  <div class="wrap clearfix">
    <div class="wrap_lf">
      <div class="xz_list clearfix">
        <div class="list_md">
          <div class="md_hd"> <img class="img" src="<?=$public_r['add_jianzhanzj_com_url']?><?=empty($ecms_gr[titlepic])?$public_r[newsurl].'e/data/images/notimg.gif':$ecms_gr[titlepic]?>" alt="<?=$ecms_gr[title]?>"> </div>
...
?>
            <li> <img src="<?=$public_r['add_jianzhanzj_com_url']?><?=$spicr[1]?>" alt="<?=$ecms_gr[title]?>"> </li>
<?php } ?>
...
?>
          ...
          <li class="item"> <a class="pic-group" href="<?=$bqsr['titleurl']?>" target="_blank" title="<?=$bqr['title']?>"> <img class="pic" src="<?=$public_r['add_jianzhanzj_com_url']?><?=$bqr['titlepic']?>" alt="<?=$bqr['title']?>">
...
$bqno++;
?>
            <li class="item"> <a href="<?=$bqsr['titleurl']?>" target="_blank" title="<?=$bqr['title']?>"> <img class="pic" src="<?=$public_r['add_jianzhanzj_com_url']?><?=$bqr['titlepic']?>">
              <div class="tit"><?=$bqr['title']?></div>
              </a> </li>
             <?php
}
...
$bqno++;
?> 
          <li class="item"> <a href="<?=$bqsr['titleurl']?>" target="_blank" title="<?=$bqr['title']?>"> <img class="pic" src="<?=$public_r['add_jianzhanzj_com_url']?><?=$bqr['titlepic']?>" alt="<?=$bqr['title']?>">
            <div class="tit"><?=$bqr['title']?></div>
            </a> </li>
          <?php
}
...
?>
        <ul class="hot_games bd-item on">
            <li> <a href="<?=$bqsr['titleurl']?>" target="_blank" class="img"><img src="<?=$public_r['add_jianzhanzj_com_url']?><?=$bqr['titlepic']?>" alt="<?=$bqr['title']?>"></a>
...
?>>
              ...
              <div class="lb_hover"> <em class="no1"><?=$bqno?></em>
                <div class="lb_icon"><a href="<?=$bqsr['titleurl']?>" target="_blank"><img src="<?=$public_r['add_jianzhanzj_com_url']?><?=$bqr['titlepic']?>" alt="<?=$bqr['title']?>"><span class="cover_89"></span></a></div>
                <div class="lb_intro">
