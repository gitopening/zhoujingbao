...
?> <a class="nav-link" href="/zt/">专题</a> <a class="nav-link" href="/top/">排行</a> </nav>
  ...
  <section class="page-content">
    <ul class="url-here">
      <li><a href="/">首页</a></li>
      <li><a href="/<?=$class_r[$navclassid][classpath]?>/">[!--class.name--]</a></li>
...
$bqno++;
?>																							
         <a href="<?=$bqsr[classurl]?>" class="item <? if($bqr['classid']==$GLOBALS['navclassid']){?>on<? } ?>"><?=$bqr[classname]?></a>													
	 <?php
}
}
?> 
      ...
      <div class="article-list list" id="listContent"> 
         [!--empirenews.listtemp--]
<!--list.var1-->
