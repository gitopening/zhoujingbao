...
$gamepage=gamepage($num,$line,$page_line,$start,$page,$search2);
$softpage=softpage($num,$line,$page_line,$start,$page,$search2);
$pcpage=pcpage($num,$line,$page_line,$start,$page,$search2);
//页面支持标签
if($public_r['dtcanbq'])
{
...
$listtemp=str_replace('[!--show.gamepage--]',$gamepage,$listtemp);
$listtemp=str_replace('[!--show.softpage--]',$softpage,$listtemp);
$listtemp=str_replace('[!--show.pcpage--]',$pcpage,$listtemp);
//取得列表模板
