...
$ecms_config['db']['dbusername']='zhoujingbao_com';	//数据库用户名
$ecms_config['db']['dbpassword']='FLm8JkPnrpjJsxCf';	//数据库密码
$ecms_config['db']['dbname']='zhoujingbao_com';	//数据库名
$ecms_config['db']['setchar']='utf8';	//设置默认编码
$ecms_config['db']['dbchar']='utf8';	//数据库默认编码
$ecms_config['db']['dbtbpre']='jianzhanzj_com_';	//数据表前缀
...
$ecms_config['esafe']['ecookiernd']='IVhdVTjxB8lA4LLEt45UIqZoKfdYUcuwhU8h';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='pxpky';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='dkwui';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='zie5iKuFCoKf1erSHUmAj12PdMjMgVl1a8h';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='qtkhv688VQlUGDzV0J94E1vcgLtIAidCKH';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='nX8sVrXVqj0pqCHPB5HiO7V4E6W3EL6ak';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='5oRBlAnH2Dzbr4AXGnQe3THAlv2laHXz';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='WFJ7QPMXIpIARooKPji76a1GP4zR4BT';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'周景宝下载-安卓游戏下载大全-热门好玩的手游排行榜',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'jSxCVfBOIbF0Aofa84DPrzekCNKdb1yo',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/game/\">手机游戏</a>&nbsp;|&nbsp;<a href=\"/app/\">手机软件</a>&nbsp;|&nbsp;<a href=\"/soft/\">电脑软件</a>&nbsp;|&nbsp;<a href=\"/news/\">资讯攻略</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'dbxUrJ8YZegKXvu1DraCSOevuDLaUViOnkmq',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'hjZp2IrvfmWE8VL4mHkHnm38YAPjnTs9FL7gxBrTlS',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>1,
...
'ctimeaddre'=>0,
'ctimeqaddre'=>0,
'deftempid'=>0,'add_jianzhanzj_com_url'=>'http://www.zhoujingbao.com','add_jianzhanzj_com_murl'=>'http://m.zhoujingbao.com','add_jianzhanzj_com_name'=>'周景宝下载');
//------------e_public
...
'pname'=>'主访问端',
'purl'=>'http://www.zhoujingbao.com/',
'ppath'=>'/www/wwwroot/zhoujingbao.com/',
'postpass'=>'NvDDKUal5eeJ7RXaBLwUFaI3jYzIzbx99pwqMrLoE9pKuZogP8SgKE5A6y58',
'postfile'=>'',
'tempgid'=>'0',
'isclose'=>'0',
'closeadd'=>'0',
...
'pname'=>'手机端',
'purl'=>'http://m.zhoujingbao.com/',
'ppath'=>'/www/wwwroot/zhoujingbao.com/m/',
'postpass'=>'Spe6AhSkzRZKjR4kKTOFQkm4rriwBSifUEh1HvrgiHR5IJCur3mPyE8L6cXO',
'postfile'=>'',
'tempgid'=>'2',
'isclose'=>'0',
'closeadd'=>'0',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,special.field,newstime,titlepic,gametype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'qenter'=>',title,',
'listtempf'=>',title,ftitle,newstime,titlepic,gametype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,',
'tempf'=>',title,ftitle,newstime,titlepic,gametype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,',
'mustqenterf'=>',title,',
'listandf'=>',gametype,',
'setandf'=>0,
'searchvar'=>'',
'cj'=>',title,',
'canaddf'=>',title,ftitle,newstime,titlepic,gametype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'caneditf'=>',title,ftitle,newstime,titlepic,gametype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,gametype,yuyan,banben,daxiao,dengji,anurl,iosurl,morepic,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,gametype,yuyan,banben,daxiao,dengji,anurl,iosurl,morepic,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,special.field,newstime,titlepic,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'qenter'=>',',
'listtempf'=>',title,ftitle,newstime,titlepic,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,diggtop,',
'tempf'=>',title,ftitle,newstime,titlepic,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'mustqenterf'=>',title,',
'listandf'=>',softtype,',
'setandf'=>0,
'searchvar'=>'',
'cj'=>',title,',
'canaddf'=>',title,ftitle,newstime,titlepic,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'caneditf'=>',title,ftitle,newstime,titlepic,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,morepic,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,morepic,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'qeditdofunf'=>'||',
'definfovoteid'=>0,
'orderf'=>',title,ftitle,newstime,titlepic,softtype,yuyan,banben,daxiao,dengji,anurl,iosurl,smalltext,morepic,',
'sonclass'=>'|2|',
'maddfun'=>'',
'meditfun'=>'',
'qmaddfun'=>'',
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,ftitle,special.field,newstime,titlepic,pctype,yuyan,banben,daxiao,dengji,pcurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'qenter'=>',',
'listtempf'=>',title,ftitle,newstime,titlepic,pctype,yuyan,banben,daxiao,dengji,pcurl,smalltext,morepic,diggtop,',
'tempf'=>',title,ftitle,newstime,titlepic,pctype,yuyan,banben,daxiao,dengji,pcurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'mustqenterf'=>',title,',
'listandf'=>',pctype,',
'setandf'=>0,
'searchvar'=>'',
'cj'=>',title,',
'canaddf'=>',title,ftitle,newstime,titlepic,pctype,yuyan,banben,daxiao,dengji,pcurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'caneditf'=>',title,ftitle,newstime,titlepic,pctype,yuyan,banben,daxiao,dengji,pcurl,smalltext,morepic,writer,befrom,newstext,diggtop,',
'tbmainf'=>',title,titlepic,newstime,ftitle,smalltext,diggtop,pctype,yuyan,banben,daxiao,dengji,pcurl,morepic,',
'tbdataf'=>',writer,befrom,newstext,',
'tobrf'=>',smalltext,newstext,',
'dohtmlf'=>',ftitle,smalltext,writer,befrom,newstext,diggtop,pctype,yuyan,banben,daxiao,dengji,pcurl,morepic,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'qeditdofunf'=>'||',
'definfovoteid'=>0,
'orderf'=>',title,ftitle,newstime,titlepic,pctype,yuyan,banben,daxiao,dengji,pcurl,smalltext,morepic,diggtop,',
'sonclass'=>'|3|',
'maddfun'=>'',
'meditfun'=>'',
'qmaddfun'=>'',
