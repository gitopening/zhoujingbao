...
<a onclick="window.open('ecmseditor/FileMain.php?type=1&classid=<?=$classid?>&infoid=<?=$id?>&filepass=<?=$filepass?>&sinfo=1&doing=1&field=titlepic<?=$ecms_hashur[ehref]?>','','width=700,height=550,scrollbars=yes');" title="选择已上传的图片"><img src="../data/images/changeimg.gif" border="0" align="absbottom"></a></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>游戏分类</td><td bgcolor='ffffff'><input name="softtype" type="radio" value="1"<?=$r[softtype]=="1"||$ecmsfirstpost==1?' checked':''?>>系统工具<input name="softtype" type="radio" value="2"<?=$r[softtype]=="2"?' checked':''?>>办公软件<input name="softtype" type="radio" value="3"<?=$r[softtype]=="3"?' checked':''?>>图形图像<input name="softtype" type="radio" value="4"<?=$r[softtype]=="4"?' checked':''?>>社交软件<input name="softtype" type="radio" value="5"<?=$r[softtype]=="5"?' checked':''?>>生活服务<input name="softtype" type="radio" value="6"<?=$r[softtype]=="6"?' checked':''?>>手机杀毒<input name="softtype" type="radio" value="7"<?=$r[softtype]=="7"?' checked':''?>>应用工具<input name="softtype" type="radio" value="8"<?=$r[softtype]=="8"?' checked':''?>>媒体软件<input name="softtype" type="radio" value="9"<?=$r[softtype]=="9"?' checked':''?>>其他软件</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>语言</td><td bgcolor='ffffff'>
