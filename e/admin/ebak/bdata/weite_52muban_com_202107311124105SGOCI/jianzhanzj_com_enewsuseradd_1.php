...
E_D("DROP TABLE IF EXISTS `jianzhanzj_com_enewsuseradd`;");
E_C("CREATE TABLE `jianzhanzj_com_enewsuseradd` (
...
E_D("replace into `jianzhanzj_com_enewsuseradd` values('1','0','','','','0');");
